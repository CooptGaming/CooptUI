...
-- ============================================================================
-- Event Constants
-- Integration: Wired for config invalidation (config:sell:changed, config:loot:changed).
-- Full event-driven architecture (scan events, UI state) intentionally deferred.
-- ============================================================================
Events.EVENTS = {
    CONFIG_SELL_CHANGED = 'config:sell:changed',
    CONFIG_LOOT_CHANGED = 'config:loot:changed',
}
