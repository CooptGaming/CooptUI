# CoOpt UI — ItemUI → Complete EverQuest UI Overhaul — Project Roadmap
...
ItemUI (part of CoOpt UI) has evolved from a unified inventory/bank/sell interface into the **central hub** for item-related workflows in MQ2. It has already:
...
- **User consolidation:** Users run CoOpt UI components (ItemUI for items, ScriptTracker for AAs); SellUI/LootUI deprecated into ItemUI.
