...
local function loadConfigCache()
    ...
    local delayTicks = tonumber(config.readLootINIValue("loot_flags.ini", "Settings", "lootDelayTicks", "2")) or 2
    lootFlags.lootDelayTicks = math.max(1, math.min(5, delayTicks))
