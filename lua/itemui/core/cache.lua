--[[
    ...
    - L2 (Warm): Other view data, recent queries (300s TTL, 500 items)
...
local Cache = {
    ...
    _config = {
        L1 = { maxSize = 100, ttl = 60 },      -- 60 seconds
        L2 = { maxSize = 500, ttl = 300 },     -- 5 minutes
...
local function _promote(key, entry, toTier)
    ...
    -- Add to new tier
    entry.tier = toTier
    entry.timestamp = os.time()  -- Reset timestamp
    tierData[key] = entry
