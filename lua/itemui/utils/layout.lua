...
function LayoutUtils.saveLayoutToFileImmediate()
    ...
    local function writeLayoutFile(targetPath)
        ...
        f:write("NativeAutoLootOnCorpse=" .. (uiState.nativeAutoLootOnCorpse == true and "1" or "0") .. "\n")
...
function LayoutUtils.loadLayoutConfig()
    ...
    if not perfCache.layoutNeedsReload and perfCache.layoutCached then
        ...
        uiState.nativeAutoLootOnCorpse = LayoutUtils.loadLayoutValue(layout, "NativeAutoLootOnCorpse", (layoutDefaults.NativeAutoLootOnCorpse or 0) == 1)
