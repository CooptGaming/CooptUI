...
local function layout_setup_captureCurrentLayoutAsDefault()
    ...
    layoutDefaults.ShowDreamRiver = layoutConfig.ShowDreamRiver or layoutDefaults.ShowDreamRiver or 0
    layoutDefaults.ExperimentStagecraft = layoutConfig.ExperimentStagecraft or layoutDefaults.ExperimentStagecraft or 0
    layoutDefaults.DreamRiverWindowX = layoutConfig.DreamRiverWindowX or layoutDefaults.DreamRiverWindowX
    layoutDefaults.DreamRiverWindowY = layoutConfig.DreamRiverWindowY or layoutDefaults.DreamRiverWindowY
    layoutDefaults.WidthDreamRiver = layoutConfig.WidthDreamRiver or layoutDefaults.WidthDreamRiver
    layoutDefaults.HeightDreamRiver = layoutConfig.HeightDreamRiver or layoutDefaults.HeightDreamRiver
    ...
    if path then
        ...
        local function writeDefaultsFile(targetPath)
            ...
            f:write("ShowDreamRiver=" .. (layoutDefaults.ShowDreamRiver or 0) .. "\n")
            f:write("ExperimentStagecraft=" .. (layoutDefaults.ExperimentStagecraft or 0) .. "\n")
            f:write("DreamRiverWindowX=" .. (layoutDefaults.DreamRiverWindowX or 0) .. "\n")
            f:write("DreamRiverWindowY=" .. (layoutDefaults.DreamRiverWindowY or 0) .. "\n")
            f:write("WidthDreamRiver=" .. (layoutDefaults.WidthDreamRiver or 560) .. "\n")
            f:write("HeightDreamRiver=" .. (layoutDefaults.HeightDreamRiver or 460) .. "\n")
...
local function layout_setup_resetLayoutToDefault()
    ...
    layoutConfig.ShowDreamRiver = layoutDefaults.ShowDreamRiver or 0
    layoutConfig.ExperimentStagecraft = layoutDefaults.ExperimentStagecraft or 0
    layoutConfig.DreamRiverWindowX = layoutDefaults.DreamRiverWindowX or 0
    layoutConfig.DreamRiverWindowY = layoutDefaults.DreamRiverWindowY or 0
    layoutConfig.WidthDreamRiver = layoutDefaults.WidthDreamRiver or 560
    layoutConfig.HeightDreamRiver = layoutDefaults.HeightDreamRiver or 460
