...
function ItemTooltip.renderStatsTooltip(item, ctx, opts)
    ...
    -- The score line renders INSIDE renderItemDisplayContent's column child now
    -- (tooltip_render tail) - drawn out here it sat past the window edge, the
    -- field's clipped green number.
end
